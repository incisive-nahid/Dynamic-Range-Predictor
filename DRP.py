# Dynamic Range Predictor Web App by 24_DS_IV_14
...
st.write('''# Dynamic Range Predictor''')  # title
st.sidebar.image("Images/StockStreamLogo1.png", width=250,use_column_width=False)  # logo
st.sidebar.write('''# DRP''')

with st.sidebar: 
        selected = option_menu("Utilities", ["Stocks Performance Comparison", "Real-Time Stock Price", "Stock Prediction", 'About'])

start = st.sidebar.date_input(
    'Start', datetime.date(2023, 1, 1))  # start date input
...
# Stock Price Prediction Section Ends Here
    ...
    st.markdown('<p class="big-font">Dynamic Range Predictor is a web application that allows users to visualize Stock Performance Comparison, Real-Time Stock Prices and Stock Price Prediction. This application is developed using Streamlit. Streamlit is an open source app framework in Python language. It helps users to create web apps for Data Science and Machine Learning in a short time.</p>', unsafe_allow_html=True)
    st.subheader('Kishan Singh [![Repo](https://badgen.net/badge/icon/GitHub?icon=github&label)](https://github.com/git-hub-Kishan) ')
    st.subheader('Nahid Anjum [![Repo](https://badgen.net/badge/icon/GitHub?icon=github&label)](https://github.com/incisive-nahid) ')
    st.subheader('Prachi Jain [![Repo](https://badgen.net/badge/icon/GitHub?icon=github&label)](https://github.com/prac1312hi) ')
    st.subheader('Ajay Singh [![Repo](https://badgen.net/badge/icon/GitHub?icon=github&label)](https://github.com/AJAY230) ')
    st.subheader('Muskan rajpoot [![Repo](https://badgen.net/badge/icon/GitHub?icon=github&label)](https://github.com/muskanr336) ')
